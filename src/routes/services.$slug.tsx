      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pt-24 pb-20 md:px-8 md:pt-32 md:pb-28">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a href={wa(bookMsg)} target="_blank" rel="noopener noreferrer" data-ga-name={`WhatsApp — ${s.title}`} data-ga-context="service_page" className="inline-flex items-center gap-2 rounded-full bg-[var(--whatsapp-ink)] px-6 py-3 text-sm font-semibold text-white shadow-elegant hover:opacity-90">
              💬 Book on WhatsApp
            </a>
